...
public:
    ...
    void Draw(Orbiter* camera, Dirlight* dirLight, vector<PointLight*> pointLights, GLuint waterShader);
    void Draw(Orbiter* camera, Dirlight* dirLight, vector<PointLight*> pointLights, GLuint reflec, GLuint refrac);
