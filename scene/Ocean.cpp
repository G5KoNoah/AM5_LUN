...
Ocean::Ocean(std::string strShader, std::string strTexture1, Transform tr, Entity* p) : Plane(strShader, strTexture1, tr, p) {
}

Ocean::Ocean(std::string strShader, std::string strTexture1, std::string strTexture2, Transform tr, Entity* p) : Plane(strShader, strTexture1, strTexture2, tr, p) {
}

Ocean::Ocean(std::string strShader, vec3 c, Transform tr, Entity* p) : Plane(strShader, c, tr, p) {
}

void Ocean::Draw(Orbiter* camera, Dirlight* dirLight, vector<PointLight*> pointLights) {
